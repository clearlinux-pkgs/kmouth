...
Version  : 20.04.1
Release  : 20
URL      : https://download.kde.org/stable/release-service/20.04.1/src/kmouth-20.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.1/src/kmouth-20.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.1/src/kmouth-20.04.1.tar.xz.sig
...
%prep
%setup -q -n kmouth-20.04.1
cd %{_builddir}/kmouth-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589842521
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmouth-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/kmouth/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kmouth-20.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmouth/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kmouth
